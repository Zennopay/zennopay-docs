...
[PaymentSheet](/sdks/overview) on the user's device. The SDK renders the whole
...
<CardGroup cols={2}>
  <Card title="PaymentSheet overview" icon="layer-group" href="/sdks/overview" />
  <Card title="Session endpoint" icon="server" href="/sdks/session-endpoint" />
