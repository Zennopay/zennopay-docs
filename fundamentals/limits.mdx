---
title: "QR Payments limits"
description: "The corridor limits enforced against a QR Payments user identifier."
sidebarTitle: "Payment limits"
---

Each QR Payments corridor carries per-user regulatory limits set by the destination
