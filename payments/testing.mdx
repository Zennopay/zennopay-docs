...
|---|---|---|
| [iOS](/payments/ios) | `config: .staging` | `config: .production` |
| [Android](/payments/android) | `ZennopayConfig.STAGING` | `ZennopayConfig.PRODUCTION` |
| [Flutter](/payments/flutter) | `ZennopayConfig.staging` | `ZennopayConfig.production` |
| [React Native](/payments/react-native) | `{ environment: 'staging' }` | `{ environment: 'production' }` |
