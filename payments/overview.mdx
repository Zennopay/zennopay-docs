...
|---|---|---|---|
| [iOS](/payments/ios) | `Zennopay` (Swift Package) | `https://github.com/Zennopay/zennopay-ios-sdk` | iOS 16, Swift 5.9 |
| [Android](/payments/android) | `com.zennopay:sdk` (Maven) | `implementation("com.zennopay:sdk:0.2.0")` | minSdk 24, Compose |
| [Flutter](/payments/flutter) | `zennopay_flutter` (pub.dev) | `zennopay_flutter: ^0.1.0` | Flutter 3.19, Dart 3.4 |
