---
title: "QR Payments API playground"
description: "Try the QR payment-intent endpoints against the sandbox server."
---

Use the interactive playground below to exercise the QR Payments API
...
schema before they're sent. Platform Payouts is documented separately in the
[Payouts API reference](/platform-payouts/payouts) and is not yet included in
this downloadable OpenAPI document.
