...
<CodeGroup>
```bash Sandbox
curl https://api.sandbox.zennopay.in/v1/payment_intents/zp_AbCd1234EfGh5678/receipt \
  -H "Authorization: Bearer <receiptToken>"
```

```bash Production
curl https://api.zennopay.in/v1/payment_intents/zp_AbCd1234EfGh5678/receipt \
  -H "Authorization: Bearer <receiptToken>"
```
</CodeGroup>
