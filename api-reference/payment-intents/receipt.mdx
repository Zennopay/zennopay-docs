...
<ParamField path="intent_id" type="string" required>
  Zennopay intent ID, e.g. `0198f31a-7c2b-7d91-9fa2-112233445566`.
</ParamField>
...
<CodeGroup>
```bash Sandbox
curl https://api.sandbox.zennopay.com/v1/payment_intents/0198f31a-7c2b-7d91-9fa2-112233445566/receipt \
  -H "Authorization: Bearer <receiptToken>"
```

```bash Production
curl https://api.zennopay.com/v1/payment_intents/0198f31a-7c2b-7d91-9fa2-112233445566/receipt \
  -H "Authorization: Bearer <receiptToken>"
```
</CodeGroup>
