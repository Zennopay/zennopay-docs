...
<Note>
  Platform Payouts is a server-initiated transfer to a beneficiary. It is not
  the merchant-delivery step inside [QR Payments](/qr-payments/overview), and
  it does not use PaymentSheet or a payment intent.
</Note>
