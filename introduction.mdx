...
<CardGroup cols={2}>
  ...
  <Card title="Mobile app developers" icon="mobile" href="/payments/overview">
    Present the native Zennopay PaymentSheet from iOS, Android, Flutter, or React Native.
  </Card>
</CardGroup>
...
- **Two-layer auth.** Long-lived HMAC on the server side, short-lived
  per-session JWT on the client side — the dual-token pattern common to
  modern payment APIs.
